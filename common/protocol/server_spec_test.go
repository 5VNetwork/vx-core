...
// 	spec := NewServerSpec(net.Tuple3{}, AlwaysValid(), &MemoryUser{
...
// 	spec := NewServerSpec(net.Tuple3{}, AlwaysValid(), &MemoryUser{Email: "test1@v2fly.org"}, &MemoryUser{Email: "test2@v2fly.org"}, &MemoryUser{Email: "test3@v2fly.org"})
// 	user := spec.PickUser()
