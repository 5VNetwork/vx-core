...
const (
	...
	Regex Type = 3
	// Prefix is the type of matcher that the input string must start with the pattern.
	Prefix Type = 4
)

// Matcher is the interface to determine a string matches a pattern.
//   - This is a basic match represent a certain kind of match semantic(full, substr, domain or regex).
