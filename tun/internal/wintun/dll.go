...
func (d *lazyDLL) Load() error {
	...
	// filepath.Join(common.GetExecutableDir(), "inbound", "tun", "internal", "wintun", d.Name)
	// "..\\..\\internal\\inbound\\tun\\internal\\wintun\\amd64\\wintun.dll"
	module, err := windows.LoadLibraryEx(d.Name, 0, LOAD_LIBRARY_SEARCH_USER_DIRS)
	if err != nil {
