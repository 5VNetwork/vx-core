...
const file_transport_protocols_grpc_encoding_stream_proto_rawDesc = "" +
	...
	"\bTunMulti\x12..x.transport.protocols.grpc.encoding.MultiHunk\x1a..x.transport.protocols.grpc.encoding.MultiHunk(\x010\x01B@Z>github.com/5vnetwork/vx-core/transport/protocols/grpc/encodingb\x06proto3"
