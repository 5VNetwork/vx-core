...
const (
	GRPCService_Tun_FullMethodName      = "/x.transport.protocols.grpc.encoding.GRPCService/Tun"
	GRPCService_TunMulti_FullMethodName = "/x.transport.protocols.grpc.encoding.GRPCService/TunMulti"
)
...
var GRPCService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "x.transport.protocols.grpc.encoding.GRPCService",
	...
	Metadata: "transport/protocols/grpc/encoding/stream.proto",
}
