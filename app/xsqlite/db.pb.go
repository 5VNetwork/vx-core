...
const file_db_proto_rawDesc = "" +
	...
	"\n" +
	"DbHandlers\x124\n" +
	"\bhandlers\x18\x01 \x03(\v2\x18.vx.db.DbOutboundHandlerR\bhandlers\"\xd2\x02\n" +
	...
	"\x06domain\x18\x01 \x01(\tR\x06domain2\xa0\x03\n" +
	"\tDbService\x12@\n" +
	"\n" +
	"GetHandler\x12\x18.vx.db.GetHandlerRequest\x1a\x18.vx.db.DbOutboundHandler\x12A\n" +
	"\x0eGetAllHandlers\x12\x1c.vx.db.GetAllHandlersRequest\x1a\x11.vx.db.DbHandlers\x12I\n" +
	"\x12GetHandlersByGroup\x12 .vx.db.GetHandlersByGroupRequest\x1a\x11.vx.db.DbHandlers\x12I\n" +
	"\x12GetBatchedHandlers\x12 .vx.db.GetBatchedHandlersRequest\x1a\x11.vx.db.DbHandlers\x12<\n" +
	"\rUpdateHandler\x12\x1b.vx.db.UpdateHandlerRequest\x1a\x0e.vx.db.Receipt\x12:\n" +
	"\fAddGeoDomain\x12\x1a.vx.db.AddGeoDomainRequest\x1a\x0e.vx.db.ReceiptBs\n" +
	"\tcom.vx.dbB\aDbProtoP\x01Z(github.com/5vnetwork/vx-core/app/xsqlite\xa2\x02\x03VDX\xaa\x02\x05Vx.Db\xca\x02\x05Vx\\Db\xe2\x02\x11Vx\\Db\\GPBMetadata\xea\x02\x06Vx::Dbb\x06proto3"
...
var file_db_proto_goTypes = []any{
	(*Receipt)(nil),                   // 0: vx.db.Receipt
	(*GetHandlerRequest)(nil),         // 1: vx.db.GetHandlerRequest
	(*GetAllHandlersRequest)(nil),     // 2: vx.db.GetAllHandlersRequest
	(*GetHandlersByGroupRequest)(nil), // 3: vx.db.GetHandlersByGroupRequest
	(*GetBatchedHandlersRequest)(nil), // 4: vx.db.GetBatchedHandlersRequest
	(*DbHandlers)(nil),                // 5: vx.db.DbHandlers
	(*DbOutboundHandler)(nil),         // 6: vx.db.DbOutboundHandler
	(*UpdateHandlerRequest)(nil),      // 7: vx.db.UpdateHandlerRequest
	(*AddGeoDomainRequest)(nil),       // 8: vx.db.AddGeoDomainRequest
}
var file_db_proto_depIdxs = []int32{
	6, // 0: vx.db.DbHandlers.handlers:type_name -> vx.db.DbOutboundHandler
	1, // 1: vx.db.DbService.GetHandler:input_type -> vx.db.GetHandlerRequest
	2, // 2: vx.db.DbService.GetAllHandlers:input_type -> vx.db.GetAllHandlersRequest
	3, // 3: vx.db.DbService.GetHandlersByGroup:input_type -> vx.db.GetHandlersByGroupRequest
	4, // 4: vx.db.DbService.GetBatchedHandlers:input_type -> vx.db.GetBatchedHandlersRequest
	7, // 5: vx.db.DbService.UpdateHandler:input_type -> vx.db.UpdateHandlerRequest
	8, // 6: vx.db.DbService.AddGeoDomain:input_type -> vx.db.AddGeoDomainRequest
	6, // 7: vx.db.DbService.GetHandler:output_type -> vx.db.DbOutboundHandler
	5, // 8: vx.db.DbService.GetAllHandlers:output_type -> vx.db.DbHandlers
	5, // 9: vx.db.DbService.GetHandlersByGroup:output_type -> vx.db.DbHandlers
	5, // 10: vx.db.DbService.GetBatchedHandlers:output_type -> vx.db.DbHandlers
	0, // 11: vx.db.DbService.UpdateHandler:output_type -> vx.db.Receipt
	0, // 12: vx.db.DbService.AddGeoDomain:output_type -> vx.db.Receipt
