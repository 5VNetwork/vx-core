...
const (
	DbService_GetHandler_FullMethodName         = "/vx.db.DbService/GetHandler"
	DbService_GetAllHandlers_FullMethodName     = "/vx.db.DbService/GetAllHandlers"
	DbService_GetHandlersByGroup_FullMethodName = "/vx.db.DbService/GetHandlersByGroup"
	DbService_GetBatchedHandlers_FullMethodName = "/vx.db.DbService/GetBatchedHandlers"
	DbService_UpdateHandler_FullMethodName      = "/vx.db.DbService/UpdateHandler"
	DbService_AddGeoDomain_FullMethodName       = "/vx.db.DbService/AddGeoDomain"
)
...
func (UnimplementedDbServiceServer) GetAllHandlers(context.Context, *GetAllHandlersRequest) (*DbHandlers, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllHandlers not implemented")
}
func (UnimplementedDbServiceServer) GetHandlersByGroup(context.Context, *GetHandlersByGroupRequest) (*DbHandlers, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHandlersByGroup not implemented")
}
func (UnimplementedDbServiceServer) GetBatchedHandlers(context.Context, *GetBatchedHandlersRequest) (*DbHandlers, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBatchedHandlers not implemented")
}
func (UnimplementedDbServiceServer) UpdateHandler(context.Context, *UpdateHandlerRequest) (*Receipt, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateHandler not implemented")
}
