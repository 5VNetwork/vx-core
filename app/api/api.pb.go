...
type FileTransferEvent_State int32

const (
	FileTransferEvent_STATE_UNSPECIFIED  FileTransferEvent_State = 0
	FileTransferEvent_STATE_STARTING     FileTransferEvent_State = 1
	FileTransferEvent_STATE_WAITING      FileTransferEvent_State = 2
	FileTransferEvent_STATE_CONNECTING   FileTransferEvent_State = 3
	FileTransferEvent_STATE_TRANSFERRING FileTransferEvent_State = 4
	FileTransferEvent_STATE_COMPLETED    FileTransferEvent_State = 5
	FileTransferEvent_STATE_FAILED       FileTransferEvent_State = 6
	FileTransferEvent_STATE_CANCELLED    FileTransferEvent_State = 7
)

// Enum value maps for FileTransferEvent_State.
var (
	FileTransferEvent_State_name = map[int32]string{
		0: "STATE_UNSPECIFIED",
		1: "STATE_STARTING",
		2: "STATE_WAITING",
		3: "STATE_CONNECTING",
		4: "STATE_TRANSFERRING",
		5: "STATE_COMPLETED",
		6: "STATE_FAILED",
		7: "STATE_CANCELLED",
	}
	FileTransferEvent_State_value = map[string]int32{
		"STATE_UNSPECIFIED":  0,
		"STATE_STARTING":     1,
		"STATE_WAITING":      2,
		"STATE_CONNECTING":   3,
...
func (x FileTransferEvent_State) Enum() *FileTransferEvent_State {
	p := new(FileTransferEvent_State)
	*p = x
	return p
}

func (x FileTransferEvent_State) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FileTransferEvent_State) Descriptor() protoreflect.EnumDescriptor {
	return file_app_api_api_proto_enumTypes[2].Descriptor()
}

func (FileTransferEvent_State) Type() protoreflect.EnumType {
	return &file_app_api_api_proto_enumTypes[2]
}

func (x FileTransferEvent_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FileTransferEvent_State.Descriptor instead.
func (FileTransferEvent_State) EnumDescriptor() ([]byte, []int) {
	return file_app_api_api_proto_rawDescGZIP(), []int{79, 0}
}
...
type StartFileReceiveRequest struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	SaveDir       string                      `protobuf:"bytes,1,opt,name=save_dir,json=saveDir,proto3" json:"save_dir,omitempty"`
	Inbound       *inbound.ProxyInboundConfig `protobuf:"bytes,2,opt,name=inbound,proto3" json:"inbound,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StartFileReceiveRequest) Reset() {
	*x = StartFileReceiveRequest{}
	mi := &file_app_api_api_proto_msgTypes[77]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StartFileReceiveRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartFileReceiveRequest) ProtoMessage() {}

func (x *StartFileReceiveRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_api_api_proto_msgTypes[77]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartFileReceiveRequest.ProtoReflect.Descriptor instead.
func (*StartFileReceiveRequest) Descriptor() ([]byte, []int) {
	return file_app_api_api_proto_rawDescGZIP(), []int{77}
}

func (x *StartFileReceiveRequest) GetSaveDir() string {
	if x != nil {
		return x.SaveDir
	}
	return ""
...
func (x *StartFileReceiveRequest) GetInbound() *inbound.ProxyInboundConfig {
	if x != nil {
		return x.Inbound
	}
	return nil
...
type StartFileSendRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RealmUrl      string                 `protobuf:"bytes,1,opt,name=realm_url,json=realmUrl,proto3" json:"realm_url,omitempty"`
	FilePath      string                 `protobuf:"bytes,2,opt,name=file_path,json=filePath,proto3" json:"file_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StartFileSendRequest) Reset() {
	*x = StartFileSendRequest{}
	mi := &file_app_api_api_proto_msgTypes[78]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StartFileSendRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartFileSendRequest) ProtoMessage() {}

func (x *StartFileSendRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_api_api_proto_msgTypes[78]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartFileSendRequest.ProtoReflect.Descriptor instead.
func (*StartFileSendRequest) Descriptor() ([]byte, []int) {
	return file_app_api_api_proto_rawDescGZIP(), []int{78}
}

func (x *StartFileSendRequest) GetRealmUrl() string {
	if x != nil {
		return x.RealmUrl
	}
	return ""
...
func (x *StartFileSendRequest) GetFilePath() string {
	if x != nil {
		return x.FilePath
	}
	return ""
...
type FileTransferEvent struct {
	state      protoimpl.MessageState  `protogen:"open.v1"`
	State      FileTransferEvent_State `protobuf:"varint,1,opt,name=state,proto3,enum=vx.api.FileTransferEvent_State" json:"state,omitempty"`
	...
	// STUN-discovered public UDP addresses (host:port) of the file-transfer realm listener.
	PublicAddresses []string `protobuf:"bytes,8,rep,name=public_addresses,json=publicAddresses,proto3" json:"public_addresses,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *FileTransferEvent) Reset() {
	*x = FileTransferEvent{}
	mi := &file_app_api_api_proto_msgTypes[79]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FileTransferEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FileTransferEvent) ProtoMessage() {}

func (x *FileTransferEvent) ProtoReflect() protoreflect.Message {
	mi := &file_app_api_api_proto_msgTypes[79]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FileTransferEvent.ProtoReflect.Descriptor instead.
func (*FileTransferEvent) Descriptor() ([]byte, []int) {
	return file_app_api_api_proto_rawDescGZIP(), []int{79}
}

func (x *FileTransferEvent) GetState() FileTransferEvent_State {
	if x != nil {
		return x.State
	}
	return FileTransferEvent_STATE_UNSPECIFIED
}

func (x *FileTransferEvent) GetShareUrl() string {
	if x != nil {
		return x.ShareUrl
	}
	return ""
...
func (x *FileTransferEvent) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
func (x *FileTransferEvent) GetBytesDone() uint64 {
	if x != nil {
		return x.BytesDone
	}
	return 0
...
func (x *FileTransferEvent) GetBytesTotal() uint64 {
	if x != nil {
		return x.BytesTotal
	}
	return 0
...
func (x *FileTransferEvent) GetSavePath() string {
	if x != nil {
		return x.SavePath
	}
	return ""
...
func (x *FileTransferEvent) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *FileTransferEvent) GetPublicAddresses() []string {
	if x != nil {
...
const file_app_api_api_proto_rawDesc = "" +
	...
	"\ffailed_nodes\x18\x02 \x03(\tR\vfailedNodes\"n\n" +
	"\x17StartFileReceiveRequest\x12\x19\n" +
	"\bsave_dir\x18\x01 \x01(\tR\asaveDir\x128\n" +
	"\ainbound\x18\x02 \x01(\v2\x1e.vx.inbound.ProxyInboundConfigR\ainbound\"P\n" +
	"\x14StartFileSendRequest\x12\x1b\n" +
	"\trealm_url\x18\x01 \x01(\tR\brealmUrl\x12\x1b\n" +
	"\tfile_path\x18\x02 \x01(\tR\bfilePath\"\xd3\x03\n" +
	"\x11FileTransferEvent\x125\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1f.vx.api.FileTransferEvent.StateR\x05state\x12\x1b\n" +
	...
	"bytesTotal\x12\x1b\n" +
	"\tsave_path\x18\x06 \x01(\tR\bsavePath\x12\x14\n" +
	"\x05error\x18\a \x01(\tR\x05error\x12)\n" +
	"\x10public_addresses\x18\b \x03(\tR\x0fpublicAddresses\"\xaf\x01\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eSTATE_STARTING\x10\x01\x12\x11\n" +
	"\rSTATE_WAITING\x10\x02\x12\x14\n" +
	"\x10STATE_CONNECTING\x10\x03\x12\x16\n" +
	"\x12STATE_TRANSFERRING\x10\x04\x12\x13\n" +
	"\x0fSTATE_COMPLETED\x10\x05\x12\x10\n" +
	"\fSTATE_FAILED\x10\x06\x12\x13\n" +
	"\x0fSTATE_CANCELLED\x10\a2\x8a\x18\n" +
	"\x03Api\x12@\n" +
	...
	"\x12HandlerCountryTest\x12!.vx.api.HandlerCountryTestRequest\x1a\".vx.api.HandlerCountryTestResponse\x12P\n" +
	"\x10StartFileReceive\x12\x1f.vx.api.StartFileReceiveRequest\x1a\x19.vx.api.FileTransferEvent0\x01\x12J\n" +
	"\rStartFileSend\x12\x1c.vx.api.StartFileSendRequest\x1a\x19.vx.api.FileTransferEvent0\x01Bu\n" +
	"\n" +
...
var file_app_api_api_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_app_api_api_proto_msgTypes = make([]protoimpl.MessageInfo, 85)
var file_app_api_api_proto_goTypes = []any{
	...
	(FileTransferEvent_State)(0),                  // 2: vx.api.FileTransferEvent.State
	(*ApiServerConfig)(nil),                       // 3: vx.api.ApiServerConfig
	(*XStatusChangeNotifyRequest)(nil),            // 4: vx.api.XStatusChangeNotifyRequest
	(*XStatusChangeNotifyResponse)(nil),           // 5: vx.api.XStatusChangeNotifyResponse
	(*SetSubscriptionIntervalRequest)(nil),        // 6: vx.api.SetSubscriptionIntervalRequest
	(*SetSubscriptionIntervalResponse)(nil),       // 7: vx.api.SetSubscriptionIntervalResponse
	(*UpdateSubscriptionRequest)(nil),             // 8: vx.api.UpdateSubscriptionRequest
	(*UpdateSubscriptionResponse)(nil),            // 9: vx.api.UpdateSubscriptionResponse
	(*FetchSubscriptionContentRequest)(nil),       // 10: vx.api.FetchSubscriptionContentRequest
	(*FetchSubscriptionContentResponse)(nil),      // 11: vx.api.FetchSubscriptionContentResponse
	(*SetTunNameRequest)(nil),                     // 12: vx.api.SetTunNameRequest
	(*SetTunNameResponse)(nil),                    // 13: vx.api.SetTunNameResponse
	(*DownloadRequest)(nil),                       // 14: vx.api.DownloadRequest
	(*DownloadResponse)(nil),                      // 15: vx.api.DownloadResponse
	(*HandlerIpRequest)(nil),                      // 16: vx.api.HandlerIpRequest
	(*RttTestRequest)(nil),                        // 17: vx.api.RttTestRequest
	(*RttTestResponse)(nil),                       // 18: vx.api.RttTestResponse
	(*HandlerIpResponse)(nil),                     // 19: vx.api.HandlerIpResponse
	(*HandlerUsableRequest)(nil),                  // 20: vx.api.HandlerUsableRequest
	(*HandlerUsableResponse)(nil),                 // 21: vx.api.HandlerUsableResponse
	(*HandlerCountryTestRequest)(nil),             // 22: vx.api.HandlerCountryTestRequest
	(*HandlerCountryTestResponse)(nil),            // 23: vx.api.HandlerCountryTestResponse
	(*SpeedTestRequest)(nil),                      // 24: vx.api.SpeedTestRequest
	(*SpeedTestResponse)(nil),                     // 25: vx.api.SpeedTestResponse
	(*GeoIPRequest)(nil),                          // 26: vx.api.GeoIPRequest
	(*GeoIPResponse)(nil),                         // 27: vx.api.GeoIPResponse
	(*ServerSshConfig)(nil),                       // 28: vx.api.ServerSshConfig
	(*MonitorServerRequest)(nil),                  // 29: vx.api.MonitorServerRequest
	(*MonitorServerResponse)(nil),                 // 30: vx.api.MonitorServerResponse
	(*DeployRequest)(nil),                         // 31: vx.api.DeployRequest
	(*DeployResponse)(nil),                        // 32: vx.api.DeployResponse
	(*ServerActionRequest)(nil),                   // 33: vx.api.ServerActionRequest
	(*ServerActionResponse)(nil),                  // 34: vx.api.ServerActionResponse
	(*VproxyStatusRequest)(nil),                   // 35: vx.api.VproxyStatusRequest
	(*VproxyStatusResponse)(nil),                  // 36: vx.api.VproxyStatusResponse
	(*VXRequest)(nil),                             // 37: vx.api.VXRequest
	(*ServerConfigRequest)(nil),                   // 38: vx.api.ServerConfigRequest
	(*ServerConfigResponse)(nil),                  // 39: vx.api.ServerConfigResponse
	(*UpdateServerConfigRequest)(nil),             // 40: vx.api.UpdateServerConfigRequest
	(*UpdateServerConfigResponse)(nil),            // 41: vx.api.UpdateServerConfigResponse
	(*ServerConfigJsonResponse)(nil),              // 42: vx.api.ServerConfigJsonResponse
	(*UpdateServerConfigJsonRequest)(nil),         // 43: vx.api.UpdateServerConfigJsonRequest
	(*ProcessGeoFilesRequest)(nil),                // 44: vx.api.ProcessGeoFilesRequest
	(*ProcessGeoFilesResponse)(nil),               // 45: vx.api.ProcessGeoFilesResponse
	(*DecodeRequest)(nil),                         // 46: vx.api.DecodeRequest
	(*DecodeResponse)(nil),                        // 47: vx.api.DecodeResponse
	(*GetServerPublicKeyRequest)(nil),             // 48: vx.api.GetServerPublicKeyRequest
	(*GetServerPublicKeyResponse)(nil),            // 49: vx.api.GetServerPublicKeyResponse
	(*GenerateCertRequest)(nil),                   // 50: vx.api.GenerateCertRequest
	(*GenerateCertResponse)(nil),                  // 51: vx.api.GenerateCertResponse
	(*GetCertDomainRequest)(nil),                  // 52: vx.api.GetCertDomainRequest
	(*GetCertDomainResponse)(nil),                 // 53: vx.api.GetCertDomainResponse
	(*AddInboundRequest)(nil),                     // 54: vx.api.AddInboundRequest
	(*AddInboundResponse)(nil),                    // 55: vx.api.AddInboundResponse
	(*UploadLogRequest)(nil),                      // 56: vx.api.UploadLogRequest
	(*UploadLogResponse)(nil),                     // 57: vx.api.UploadLogResponse
	(*DefaultNICHasGlobalV6Request)(nil),          // 58: vx.api.DefaultNICHasGlobalV6Request
	(*DefaultNICHasGlobalV6Response)(nil),         // 59: vx.api.DefaultNICHasGlobalV6Response
	(*UpdateTmStatusRequest)(nil),                 // 60: vx.api.UpdateTmStatusRequest
	(*Receipt)(nil),                               // 61: vx.api.Receipt
	(*ParseClashRuleFileRequest)(nil),             // 62: vx.api.ParseClashRuleFileRequest
	(*ParseClashRuleFileResponse)(nil),            // 63: vx.api.ParseClashRuleFileResponse
	(*ParseGeositeConfigRequest)(nil),             // 64: vx.api.ParseGeositeConfigRequest
	(*ParseGeositeConfigResponse)(nil),            // 65: vx.api.ParseGeositeConfigResponse
	(*ParseGeoIPConfigRequest)(nil),               // 66: vx.api.ParseGeoIPConfigRequest
	(*ParseGeoIPConfigResponse)(nil),              // 67: vx.api.ParseGeoIPConfigResponse
	(*GenerateX25519KeyPairRequest)(nil),          // 68: vx.api.GenerateX25519KeyPairRequest
	(*GenerateX25519KeyPairResponse)(nil),         // 69: vx.api.GenerateX25519KeyPairResponse
	(*GenerateECHRequest)(nil),                    // 70: vx.api.GenerateECHRequest
	(*GenerateECHResponse)(nil),                   // 71: vx.api.GenerateECHResponse
	(*StartMacSystemProxyRequest)(nil),            // 72: vx.api.StartMacSystemProxyRequest
	(*StopMacSystemProxyRequest)(nil),             // 73: vx.api.StopMacSystemProxyRequest
	(*CloseDbRequest)(nil),                        // 74: vx.api.CloseDbRequest
	(*OpenDbRequest)(nil),                         // 75: vx.api.OpenDbRequest
	(*InboundConfigToOutboundConfigRequest)(nil),  // 76: vx.api.InboundConfigToOutboundConfigRequest
	(*InboundConfigToOutboundConfigResponse)(nil), // 77: vx.api.InboundConfigToOutboundConfigResponse
	(*ToUrlRequest)(nil),                          // 78: vx.api.ToUrlRequest
	(*ToUrlResponse)(nil),                         // 79: vx.api.ToUrlResponse
	(*StartFileReceiveRequest)(nil),               // 80: vx.api.StartFileReceiveRequest
	(*StartFileSendRequest)(nil),                  // 81: vx.api.StartFileSendRequest
	(*FileTransferEvent)(nil),                     // 82: vx.api.FileTransferEvent
	nil,                                           // 83: vx.api.UpdateSubscriptionResponse.ErrorReasonsEntry
	nil,                                           // 84: vx.api.FetchSubscriptionContentRequest.ShareLinkQueryExtraEntry
	nil,                                           // 85: vx.api.DownloadResponse.UsageEntry
	nil,                                           // 86: vx.api.DeployRequest.FilesEntry
	nil,                                           // 87: vx.api.DecodeRequest.ShareLinkQueryExtraEntry
	(*log.LoggerConfig)(nil),                      // 88: vx.log.LoggerConfig
	(*outbound.HandlerConfig)(nil),                // 89: vx.outbound.HandlerConfig
	(*outbound.OutboundHandlerConfig)(nil),        // 90: vx.outbound.OutboundHandlerConfig
	(*vx.ServerConfig)(nil),                       // 91: vx.ServerConfig
	(*inbound.ProxyInboundConfig)(nil),            // 92: vx.inbound.ProxyInboundConfig
	(*geo.Domain)(nil),                            // 93: vx.common.geo.Domain
	(*geo.CIDR)(nil),                              // 94: vx.common.geo.CIDR
	(*router.AppId)(nil),                          // 95: vx.router.AppId
	(*geo1.GeositeConfig)(nil),                    // 96: vx.geo.GeositeConfig
	(*geo1.GeoIPConfig)(nil),                      // 97: vx.geo.GeoIPConfig
	(*inbound.MultiProxyInboundConfig)(nil),       // 98: vx.inbound.MultiProxyInboundConfig
}
var file_app_api_api_proto_depIdxs = []int32{
	88, // 0: vx.api.ApiServerConfig.log_config:type_name -> vx.log.LoggerConfig
	0,  // 1: vx.api.XStatusChangeNotifyRequest.status:type_name -> vx.api.XStatusChangeNotifyRequest.Status
	89, // 2: vx.api.UpdateSubscriptionRequest.handlers:type_name -> vx.outbound.HandlerConfig
	83, // 3: vx.api.UpdateSubscriptionResponse.error_reasons:type_name -> vx.api.UpdateSubscriptionResponse.ErrorReasonsEntry
	89, // 4: vx.api.FetchSubscriptionContentRequest.handlers:type_name -> vx.outbound.HandlerConfig
	84, // 5: vx.api.FetchSubscriptionContentRequest.share_link_query_extra:type_name -> vx.api.FetchSubscriptionContentRequest.ShareLinkQueryExtraEntry
	90, // 6: vx.api.FetchSubscriptionContentResponse.handlers:type_name -> vx.outbound.OutboundHandlerConfig
	89, // 7: vx.api.DownloadRequest.handlers:type_name -> vx.outbound.HandlerConfig
	85, // 8: vx.api.DownloadResponse.usage:type_name -> vx.api.DownloadResponse.UsageEntry
	90, // 9: vx.api.HandlerIpRequest.handler:type_name -> vx.outbound.OutboundHandlerConfig
	89, // 10: vx.api.HandlerUsableRequest.handler:type_name -> vx.outbound.HandlerConfig
	89, // 11: vx.api.HandlerCountryTestRequest.handler:type_name -> vx.outbound.HandlerConfig
	89, // 12: vx.api.SpeedTestRequest.handlers:type_name -> vx.outbound.HandlerConfig
	28, // 13: vx.api.MonitorServerRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	28, // 14: vx.api.DeployRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	86, // 15: vx.api.DeployRequest.files:type_name -> vx.api.DeployRequest.FilesEntry
	91, // 16: vx.api.DeployRequest.vx_config:type_name -> vx.ServerConfig
	1,  // 17: vx.api.ServerActionRequest.action:type_name -> vx.api.ServerActionRequest.Action
	28, // 18: vx.api.ServerActionRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	28, // 19: vx.api.VproxyStatusRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	28, // 20: vx.api.VXRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	28, // 21: vx.api.ServerConfigRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	91, // 22: vx.api.ServerConfigResponse.config:type_name -> vx.ServerConfig
	28, // 23: vx.api.UpdateServerConfigRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	91, // 24: vx.api.UpdateServerConfigRequest.config:type_name -> vx.ServerConfig
	28, // 25: vx.api.UpdateServerConfigJsonRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	87, // 26: vx.api.DecodeRequest.share_link_query_extra:type_name -> vx.api.DecodeRequest.ShareLinkQueryExtraEntry
	90, // 27: vx.api.DecodeResponse.handlers:type_name -> vx.outbound.OutboundHandlerConfig
	28, // 28: vx.api.GetServerPublicKeyRequest.ssh_config:type_name -> vx.api.ServerSshConfig
	92, // 29: vx.api.AddInboundRequest.inbound:type_name -> vx.inbound.ProxyInboundConfig
	93, // 30: vx.api.ParseClashRuleFileResponse.domains:type_name -> vx.common.geo.Domain
	94, // 31: vx.api.ParseClashRuleFileResponse.cidrs:type_name -> vx.common.geo.CIDR
	95, // 32: vx.api.ParseClashRuleFileResponse.app_ids:type_name -> vx.router.AppId
	96, // 33: vx.api.ParseGeositeConfigRequest.config:type_name -> vx.geo.GeositeConfig
	93, // 34: vx.api.ParseGeositeConfigResponse.domains:type_name -> vx.common.geo.Domain
	97, // 35: vx.api.ParseGeoIPConfigRequest.config:type_name -> vx.geo.GeoIPConfig
	94, // 36: vx.api.ParseGeoIPConfigResponse.cidrs:type_name -> vx.common.geo.CIDR
	92, // 37: vx.api.InboundConfigToOutboundConfigRequest.inbound:type_name -> vx.inbound.ProxyInboundConfig
	98, // 38: vx.api.InboundConfigToOutboundConfigRequest.multi_inbound:type_name -> vx.inbound.MultiProxyInboundConfig
	90, // 39: vx.api.InboundConfigToOutboundConfigResponse.outbound_configs:type_name -> vx.outbound.OutboundHandlerConfig
	90, // 40: vx.api.ToUrlRequest.outbound_confogs:type_name -> vx.outbound.OutboundHandlerConfig
	92, // 41: vx.api.StartFileReceiveRequest.inbound:type_name -> vx.inbound.ProxyInboundConfig
	2,  // 42: vx.api.FileTransferEvent.state:type_name -> vx.api.FileTransferEvent.State
	60, // 43: vx.api.Api.UpdateTmStatus:input_type -> vx.api.UpdateTmStatusRequest
	14, // 44: vx.api.Api.Download:input_type -> vx.api.DownloadRequest
	20, // 45: vx.api.Api.HandlerUsable:input_type -> vx.api.HandlerUsableRequest
	24, // 46: vx.api.Api.SpeedTest:input_type -> vx.api.SpeedTestRequest
	17, // 47: vx.api.Api.RttTest:input_type -> vx.api.RttTestRequest
	26, // 48: vx.api.Api.GeoIP:input_type -> vx.api.GeoIPRequest
	48, // 49: vx.api.Api.GetServerPublicKey:input_type -> vx.api.GetServerPublicKeyRequest
	29, // 50: vx.api.Api.MonitorServer:input_type -> vx.api.MonitorServerRequest
	33, // 51: vx.api.Api.ServerAction:input_type -> vx.api.ServerActionRequest
	35, // 52: vx.api.Api.VproxyStatus:input_type -> vx.api.VproxyStatusRequest
	37, // 53: vx.api.Api.VX:input_type -> vx.api.VXRequest
	38, // 54: vx.api.Api.ServerConfig:input_type -> vx.api.ServerConfigRequest
	40, // 55: vx.api.Api.UpdateServerConfig:input_type -> vx.api.UpdateServerConfigRequest
	38, // 56: vx.api.Api.ServerConfigJson:input_type -> vx.api.ServerConfigRequest
	43, // 57: vx.api.Api.UpdateServerConfigJson:input_type -> vx.api.UpdateServerConfigJsonRequest
	8,  // 58: vx.api.Api.UpdateSubscription:input_type -> vx.api.UpdateSubscriptionRequest
	10, // 59: vx.api.Api.FetchSubscriptionContent:input_type -> vx.api.FetchSubscriptionContentRequest
	44, // 60: vx.api.Api.ProcessGeoFiles:input_type -> vx.api.ProcessGeoFilesRequest
	46, // 61: vx.api.Api.Decode:input_type -> vx.api.DecodeRequest
	31, // 62: vx.api.Api.Deploy:input_type -> vx.api.DeployRequest
	50, // 63: vx.api.Api.GenerateCert:input_type -> vx.api.GenerateCertRequest
	70, // 64: vx.api.Api.GenerateECH:input_type -> vx.api.GenerateECHRequest
	52, // 65: vx.api.Api.GetCertDomain:input_type -> vx.api.GetCertDomainRequest
	54, // 66: vx.api.Api.AddInbound:input_type -> vx.api.AddInboundRequest
	56, // 67: vx.api.Api.UploadLog:input_type -> vx.api.UploadLogRequest
	58, // 68: vx.api.Api.DefaultNICHasGlobalV6:input_type -> vx.api.DefaultNICHasGlobalV6Request
	62, // 69: vx.api.Api.ParseClashRuleFile:input_type -> vx.api.ParseClashRuleFileRequest
	64, // 70: vx.api.Api.ParseGeositeConfig:input_type -> vx.api.ParseGeositeConfigRequest
	66, // 71: vx.api.Api.ParseGeoIPConfig:input_type -> vx.api.ParseGeoIPConfigRequest
	68, // 72: vx.api.Api.GenerateX25519KeyPair:input_type -> vx.api.GenerateX25519KeyPairRequest
	72, // 73: vx.api.Api.StartMacSystemProxy:input_type -> vx.api.StartMacSystemProxyRequest
	73, // 74: vx.api.Api.StopMacSystemProxy:input_type -> vx.api.StopMacSystemProxyRequest
	74, // 75: vx.api.Api.CloseDb:input_type -> vx.api.CloseDbRequest
	75, // 76: vx.api.Api.OpenDb:input_type -> vx.api.OpenDbRequest
	76, // 77: vx.api.Api.InboundConfigToOutboundConfig:input_type -> vx.api.InboundConfigToOutboundConfigRequest
	78, // 78: vx.api.Api.ToUrl:input_type -> vx.api.ToUrlRequest
	88, // 79: vx.api.Api.SetLog:input_type -> vx.log.LoggerConfig
	22, // 80: vx.api.Api.HandlerCountryTest:input_type -> vx.api.HandlerCountryTestRequest
	80, // 81: vx.api.Api.StartFileReceive:input_type -> vx.api.StartFileReceiveRequest
	81, // 82: vx.api.Api.StartFileSend:input_type -> vx.api.StartFileSendRequest
	61, // 83: vx.api.Api.UpdateTmStatus:output_type -> vx.api.Receipt
	15, // 84: vx.api.Api.Download:output_type -> vx.api.DownloadResponse
	21, // 85: vx.api.Api.HandlerUsable:output_type -> vx.api.HandlerUsableResponse
	25, // 86: vx.api.Api.SpeedTest:output_type -> vx.api.SpeedTestResponse
	18, // 87: vx.api.Api.RttTest:output_type -> vx.api.RttTestResponse
	27, // 88: vx.api.Api.GeoIP:output_type -> vx.api.GeoIPResponse
	49, // 89: vx.api.Api.GetServerPublicKey:output_type -> vx.api.GetServerPublicKeyResponse
	30, // 90: vx.api.Api.MonitorServer:output_type -> vx.api.MonitorServerResponse
	34, // 91: vx.api.Api.ServerAction:output_type -> vx.api.ServerActionResponse
	36, // 92: vx.api.Api.VproxyStatus:output_type -> vx.api.VproxyStatusResponse
	61, // 93: vx.api.Api.VX:output_type -> vx.api.Receipt
	39, // 94: vx.api.Api.ServerConfig:output_type -> vx.api.ServerConfigResponse
	41, // 95: vx.api.Api.UpdateServerConfig:output_type -> vx.api.UpdateServerConfigResponse
	42, // 96: vx.api.Api.ServerConfigJson:output_type -> vx.api.ServerConfigJsonResponse
	41, // 97: vx.api.Api.UpdateServerConfigJson:output_type -> vx.api.UpdateServerConfigResponse
	9,  // 98: vx.api.Api.UpdateSubscription:output_type -> vx.api.UpdateSubscriptionResponse
	11, // 99: vx.api.Api.FetchSubscriptionContent:output_type -> vx.api.FetchSubscriptionContentResponse
	45, // 100: vx.api.Api.ProcessGeoFiles:output_type -> vx.api.ProcessGeoFilesResponse
	47, // 101: vx.api.Api.Decode:output_type -> vx.api.DecodeResponse
	32, // 102: vx.api.Api.Deploy:output_type -> vx.api.DeployResponse
	51, // 103: vx.api.Api.GenerateCert:output_type -> vx.api.GenerateCertResponse
	71, // 104: vx.api.Api.GenerateECH:output_type -> vx.api.GenerateECHResponse
	53, // 105: vx.api.Api.GetCertDomain:output_type -> vx.api.GetCertDomainResponse
	55, // 106: vx.api.Api.AddInbound:output_type -> vx.api.AddInboundResponse
	57, // 107: vx.api.Api.UploadLog:output_type -> vx.api.UploadLogResponse
	59, // 108: vx.api.Api.DefaultNICHasGlobalV6:output_type -> vx.api.DefaultNICHasGlobalV6Response
	63, // 109: vx.api.Api.ParseClashRuleFile:output_type -> vx.api.ParseClashRuleFileResponse
	65, // 110: vx.api.Api.ParseGeositeConfig:output_type -> vx.api.ParseGeositeConfigResponse
	67, // 111: vx.api.Api.ParseGeoIPConfig:output_type -> vx.api.ParseGeoIPConfigResponse
	69, // 112: vx.api.Api.GenerateX25519KeyPair:output_type -> vx.api.GenerateX25519KeyPairResponse
	61, // 113: vx.api.Api.StartMacSystemProxy:output_type -> vx.api.Receipt
	61, // 114: vx.api.Api.StopMacSystemProxy:output_type -> vx.api.Receipt
	61, // 115: vx.api.Api.CloseDb:output_type -> vx.api.Receipt
	61, // 116: vx.api.Api.OpenDb:output_type -> vx.api.Receipt
	77, // 117: vx.api.Api.InboundConfigToOutboundConfig:output_type -> vx.api.InboundConfigToOutboundConfigResponse
	79, // 118: vx.api.Api.ToUrl:output_type -> vx.api.ToUrlResponse
	61, // 119: vx.api.Api.SetLog:output_type -> vx.api.Receipt
	23, // 120: vx.api.Api.HandlerCountryTest:output_type -> vx.api.HandlerCountryTestResponse
	82, // 121: vx.api.Api.StartFileReceive:output_type -> vx.api.FileTransferEvent
	82, // 122: vx.api.Api.StartFileSend:output_type -> vx.api.FileTransferEvent
