...
const (
	Api_UpdateTmStatus_FullMethodName                = "/vx.api.Api/UpdateTmStatus"
	Api_Download_FullMethodName                      = "/vx.api.Api/Download"
	Api_HandlerUsable_FullMethodName                 = "/vx.api.Api/HandlerUsable"
	Api_SpeedTest_FullMethodName                     = "/vx.api.Api/SpeedTest"
	Api_RttTest_FullMethodName                       = "/vx.api.Api/RttTest"
	Api_GeoIP_FullMethodName                         = "/vx.api.Api/GeoIP"
	Api_GetServerPublicKey_FullMethodName            = "/vx.api.Api/GetServerPublicKey"
	Api_MonitorServer_FullMethodName                 = "/vx.api.Api/MonitorServer"
	Api_ServerAction_FullMethodName                  = "/vx.api.Api/ServerAction"
	Api_VproxyStatus_FullMethodName                  = "/vx.api.Api/VproxyStatus"
	Api_VX_FullMethodName                            = "/vx.api.Api/VX"
	...
	Api_ServerConfigJson_FullMethodName              = "/vx.api.Api/ServerConfigJson"
	Api_UpdateServerConfigJson_FullMethodName        = "/vx.api.Api/UpdateServerConfigJson"
	...
	Api_GenerateCert_FullMethodName                  = "/vx.api.Api/GenerateCert"
	Api_GenerateECH_FullMethodName                   = "/vx.api.Api/GenerateECH"
	Api_GetCertDomain_FullMethodName                 = "/vx.api.Api/GetCertDomain"
	Api_AddInbound_FullMethodName                    = "/vx.api.Api/AddInbound"
	Api_UploadLog_FullMethodName                     = "/vx.api.Api/UploadLog"
	Api_DefaultNICHasGlobalV6_FullMethodName         = "/vx.api.Api/DefaultNICHasGlobalV6"
	Api_ParseClashRuleFile_FullMethodName            = "/vx.api.Api/ParseClashRuleFile"
	Api_ParseGeositeConfig_FullMethodName            = "/vx.api.Api/ParseGeositeConfig"
	Api_ParseGeoIPConfig_FullMethodName              = "/vx.api.Api/ParseGeoIPConfig"
	Api_GenerateX25519KeyPair_FullMethodName         = "/vx.api.Api/GenerateX25519KeyPair"
	Api_StartMacSystemProxy_FullMethodName           = "/vx.api.Api/StartMacSystemProxy"
	Api_StopMacSystemProxy_FullMethodName            = "/vx.api.Api/StopMacSystemProxy"
	Api_CloseDb_FullMethodName                       = "/vx.api.Api/CloseDb"
	Api_OpenDb_FullMethodName                        = "/vx.api.Api/OpenDb"
...
type ApiClient interface {
	...
	ServerConfigJson(ctx context.Context, in *ServerConfigRequest, opts ...grpc.CallOption) (*ServerConfigJsonResponse, error)
	UpdateServerConfigJson(ctx context.Context, in *UpdateServerConfigJsonRequest, opts ...grpc.CallOption) (*UpdateServerConfigResponse, error)
...
func (c *apiClient) ServerConfigJson(ctx context.Context, in *ServerConfigRequest, opts ...grpc.CallOption) (*ServerConfigJsonResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServerConfigJsonResponse)
	err := c.cc.Invoke(ctx, Api_ServerConfigJson_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiClient) UpdateServerConfigJson(ctx context.Context, in *UpdateServerConfigJsonRequest, opts ...grpc.CallOption) (*UpdateServerConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateServerConfigResponse)
	err := c.cc.Invoke(ctx, Api_UpdateServerConfigJson_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiClient) SetLog(ctx context.Context, in *log.LoggerConfig, opts ...grpc.CallOption) (*Receipt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Receipt)
...
type ApiServer interface {
	...
	// Raw /usr/local/etc/vx/config.json over SSH (no client-side protobuf Any handling).
	ServerConfigJson(context.Context, *ServerConfigRequest) (*ServerConfigJsonResponse, error)
	UpdateServerConfigJson(context.Context, *UpdateServerConfigJsonRequest) (*UpdateServerConfigResponse, error)
	// rpc XStatusChangeNotify(XStatusChangeNotifyRequest) returns (XStatusChangeNotifyResponse);
	// rpc SetSubscriptionInterval(SetSubscriptionIntervalRequest) returns (SetSubscriptionIntervalResponse);
...
func (UnimplementedApiServer) UpdateTmStatus(context.Context, *UpdateTmStatusRequest) (*Receipt, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateTmStatus not implemented")
}
...
func (UnimplementedApiServer) HandlerUsable(context.Context, *HandlerUsableRequest) (*HandlerUsableResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HandlerUsable not implemented")
}
...
func (UnimplementedApiServer) GeoIP(context.Context, *GeoIPRequest) (*GeoIPResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GeoIP not implemented")
}
...
func (UnimplementedApiServer) MonitorServer(*MonitorServerRequest, grpc.ServerStreamingServer[MonitorServerResponse]) error {
	return status.Error(codes.Unimplemented, "method MonitorServer not implemented")
}
func (UnimplementedApiServer) ServerAction(context.Context, *ServerActionRequest) (*ServerActionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ServerAction not implemented")
}
func (UnimplementedApiServer) VproxyStatus(context.Context, *VproxyStatusRequest) (*VproxyStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VproxyStatus not implemented")
}
func (UnimplementedApiServer) VX(context.Context, *VXRequest) (*Receipt, error) {
	return nil, status.Error(codes.Unimplemented, "method VX not implemented")
}
func (UnimplementedApiServer) ServerConfig(context.Context, *ServerConfigRequest) (*ServerConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ServerConfig not implemented")
}
...
func (UnimplementedApiServer) ServerConfigJson(context.Context, *ServerConfigRequest) (*ServerConfigJsonResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ServerConfigJson not implemented")
}
func (UnimplementedApiServer) UpdateServerConfigJson(context.Context, *UpdateServerConfigJsonRequest) (*UpdateServerConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateServerConfigJson not implemented")
}
...
func (UnimplementedApiServer) GenerateCert(context.Context, *GenerateCertRequest) (*GenerateCertResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateCert not implemented")
}
func (UnimplementedApiServer) GenerateECH(context.Context, *GenerateECHRequest) (*GenerateECHResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateECH not implemented")
}
func (UnimplementedApiServer) GetCertDomain(context.Context, *GetCertDomainRequest) (*GetCertDomainResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCertDomain not implemented")
}
...
func (UnimplementedApiServer) DefaultNICHasGlobalV6(context.Context, *DefaultNICHasGlobalV6Request) (*DefaultNICHasGlobalV6Response, error) {
	return nil, status.Error(codes.Unimplemented, "method DefaultNICHasGlobalV6 not implemented")
}
func (UnimplementedApiServer) ParseClashRuleFile(context.Context, *ParseClashRuleFileRequest) (*ParseClashRuleFileResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseClashRuleFile not implemented")
}
func (UnimplementedApiServer) ParseGeositeConfig(context.Context, *ParseGeositeConfigRequest) (*ParseGeositeConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseGeositeConfig not implemented")
}
func (UnimplementedApiServer) ParseGeoIPConfig(context.Context, *ParseGeoIPConfigRequest) (*ParseGeoIPConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseGeoIPConfig not implemented")
}
func (UnimplementedApiServer) GenerateX25519KeyPair(context.Context, *GenerateX25519KeyPairRequest) (*GenerateX25519KeyPairResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateX25519KeyPair not implemented")
}
func (UnimplementedApiServer) StartMacSystemProxy(context.Context, *StartMacSystemProxyRequest) (*Receipt, error) {
	return nil, status.Error(codes.Unimplemented, "method StartMacSystemProxy not implemented")
}
func (UnimplementedApiServer) StopMacSystemProxy(context.Context, *StopMacSystemProxyRequest) (*Receipt, error) {
	return nil, status.Error(codes.Unimplemented, "method StopMacSystemProxy not implemented")
}
func (UnimplementedApiServer) CloseDb(context.Context, *CloseDbRequest) (*Receipt, error) {
	return nil, status.Error(codes.Unimplemented, "method CloseDb not implemented")
}
func (UnimplementedApiServer) OpenDb(context.Context, *OpenDbRequest) (*Receipt, error) {
	return nil, status.Error(codes.Unimplemented, "method OpenDb not implemented")
}
func (UnimplementedApiServer) InboundConfigToOutboundConfig(context.Context, *InboundConfigToOutboundConfigRequest) (*InboundConfigToOutboundConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InboundConfigToOutboundConfig not implemented")
}
func (UnimplementedApiServer) ToUrl(context.Context, *ToUrlRequest) (*ToUrlResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ToUrl not implemented")
}
...
func _Api_ServerConfigJson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServerConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServer).ServerConfigJson(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Api_ServerConfigJson_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).ServerConfigJson(ctx, req.(*ServerConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Api_UpdateServerConfigJson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateServerConfigJsonRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServer).UpdateServerConfigJson(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Api_UpdateServerConfigJson_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).UpdateServerConfigJson(ctx, req.(*UpdateServerConfigJsonRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Api_SetLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).SetLog(ctx, req.(*log.LoggerConfig))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Api_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ServerConfigJson",
			Handler:    _Api_ServerConfigJson_Handler,
		},
		{
			MethodName: "UpdateServerConfigJson",
			Handler:    _Api_UpdateServerConfigJson_Handler,
		},
		{
