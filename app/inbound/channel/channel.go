...
type Endpoint struct {
	...
	q *queue
	// Set this to unzero to make stack allocates more reserved bytes for PacketBuffer
	offset uint16
}

// New creates a new channel endpoint.
func New(size int, mtu uint32, linkAddr tcpip.LinkAddress, offset uint16) *Endpoint {
	return &Endpoint{
		q: &queue{
